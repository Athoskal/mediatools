...
#
#   delugeOrphans -s /home/user/mydownloads/deluge
#        Scan the directory /home/user/mydownloads/deluge and output orphaned_files.txt
#        No files will be moved from the specified -s download location.
#
#   delugeOrphans -x /home/user/trashcan
#        Scan the default download location and output orphaned_files.txt
#        Move orphaned files from the default download location to the specified -x location
#
#   delugeOrphans -s /home/user/mydownloads/deluge -x /home/user/trashcan
#        Scan the directory /home/user/mydownloads/deluge and output orphaned_files.txt
...
do
  ...
  echo -e "$fixencoding" |  php -r 'while(($line=fgets(STDIN)) !== FALSE) echo html_entity_decode($line, ENT_QUOTES|ENT_HTML401);' >> delugefiles.tmp
done
