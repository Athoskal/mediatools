...
#           echo "Access audiobookshelf at the following URL: $(tput setaf 2)https://${USER}.${HOSTNAME}.usbx.me/audiobookshelf $(tput sgr0)"
            ...
            echo
            echo "Your library paths have to be entered manually as the File Browser function does not work. Click where is says $(tput setaf 4)New folder path$(tput sgr0)."
